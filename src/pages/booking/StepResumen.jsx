    ...
    <div>
      ...
      {!requierePago && (
        <Alert tone="info" className="mb-6">
          Al confirmar, el horario queda reservado automáticamente. También podés consultar o cancelar la reserva desde Mis turnos.
        </Alert>
      )}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button onClick={confirmar} disabled={loading} className="flex-1">
          {loading ? <Spinner size="sm" /> : requierePago ? 'Ir al pago →' : 'Confirmar reserva'}
        </Button>
      </div>
    </div>
  )
